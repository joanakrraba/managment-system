...
urlpatterns = [
    ...
    path('edit_attachment/<int:attachment_id>/', views.edit_attachment, name='edit_attachment'),
    path('edit_industry/<int:industry_id>/', views.edit_industry, name='edit_industry'),
